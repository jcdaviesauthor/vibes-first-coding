...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Buddy is a form tool built for UX researchers. Screeners with quotas, research-native question types, auto-tagged open text, and a panel that remembers." },
